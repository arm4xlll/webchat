...
export const getMessages = (conversationId: string, page = 0, size = 50, signal?: AbortSignal) =>
  api.get<Message[]>(`/conversations/${conversationId}/messages?page=${page}&size=${size}`, { signal }).then(r => r.data);
